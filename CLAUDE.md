...
- LLM-Cleanup: Gemini (Cloud-Default) — aktuell `gemini-3.6-flash` mit thinking=minimal, bewusste Qualitaets-Entscheidung 2026-08-06 (Paid Tier aktiv, Limit 15 €/Monat; `gemini-3.5-flash-lite` als dokumentierte Sparoption) · Ollama + Qwen3 4B auf localhost:11434 (Offline-Backup) · Provider und Modell-IDs immer als konfigurierbare Settings, nie hartcodiert
